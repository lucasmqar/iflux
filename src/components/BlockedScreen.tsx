    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center space-y-8 animate-fade-in">
        ...
        <div className="flex justify-center">
          <img src={fluxLogo} alt="FLUX" className="w-20 h-20 object-contain" />
        </div>
        ...
        <div className="space-y-2">
          <h1 className="text-2xl font-bold text-foreground">Seu crédito expirou</h1>
          <p className="text-muted-foreground">
            Para continuar usando o FLUX, adicione créditos agora.
          </p>
        </div>
        ...
        <div className="space-y-3">
          ...
          >
            ...
            Adicionar Créditos no WhatsApp
          </Button>
